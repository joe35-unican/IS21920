...
import es.unican.is2.EmpresaEmpleados.Empleado;
import es.unican.is2.EmpresaEmpleados.Empleado.DatoIncorrectoException;
	...
	public EmpleadosGUI() {
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			    ...
			    Empleado.categorias categoria = Empleado.categorias.valueOf(comboCategoria.getSelectedItem().toString());
			    try {
